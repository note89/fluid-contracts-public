...
// TODO: newer tests:
// 14. Set limits on liquidity for withdrawal. Reach near to limit, withdrawal from operate should fail due to withdrawal gap with error VaultT1__WithdrawMoreThanOperateLimit while liquidation should pass.
...
contract VaultT1Test is VaultT1BaseTest {
    ...
    function _operateETHOnANonNativeVault(bool positiveTick_) public {
        ...
        int collateral_ = 10000 * int(10 ** vaultData_.constantVariables.supplyDecimals);
        int debt_ = 7990 * int(10 ** vaultData_.constantVariables.borrowDecimals);

        setOraclePrice(1e39, positiveTick_);

        vm.prank(alice);
        vm.expectRevert(
            abi.encodeWithSelector(Error.FluidVaultError.selector, ErrorTypes.VaultT1__InvalidMsgValueOperate)
        );
    ...
    function testNativeLiquidate() public {
        ...
        vm.prank(bob);
        vm.expectRevert(
            abi.encodeWithSelector(Error.FluidVaultError.selector, ErrorTypes.VaultT1__InvalidMsgValueLiquidate)
        );
    ...
    function _liquidateNonNative(bool positiveTick_) public {
        ...
        uint liquidateAmt_ = 1000 * (10 ** vaultData_.constantVariables.borrowDecimals);
    ...
    function testWithdrawMoreThanSupplied() public {
        ...
        vm.prank(alice);
        vm.expectRevert(
            abi.encodeWithSelector(Error.FluidVaultError.selector, ErrorTypes.VaultT1__ExcessCollateralWithdrawal)
        );
        vaultOne.operate(
            1, // new position
            -(10_000 * 1e6 + 1),
    ...
    function testPaybackMoreThanBorrowed() public {
        ...
        vm.prank(alice);
        vm.expectRevert(abi.encodeWithSelector(Error.FluidVaultError.selector, ErrorTypes.VaultT1__ExcessDebtPayback));
        vaultOne.operate(
            1, // new position
            0,
            -(7_991 * 1e18),
    ...
    function testWithdrawAndBorrowFromAnyAddress() public {
        ...
        vm.prank(bob);
        vm.expectRevert(abi.encodeWithSelector(Error.FluidVaultError.selector, ErrorTypes.VaultT1__NotAnOwner));
        vaultOne.operate(
            1, // new position
            -(1000 * 1e6),
            0,
    ...
    function testInteractFromDifferentVaultNFT() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(Error.FluidVaultError.selector, ErrorTypes.VaultT1__NftNotOfThisVault));
        vaultOne.operate(
            1, // new position
            10000 * 1e6,
            7990 * 1e18,
    ...
    function testDepositAndBorrowInvalidAmount() public {
        ...
        vm.prank(alice);
        vm.expectRevert(
            abi.encodeWithSelector(Error.FluidVaultError.selector, ErrorTypes.VaultT1__InvalidOperateAmount)
        );
    ...
    function _depositAndBorrowAboveCF(bool positiveTick_) public {
        ...
        vm.prank(alice);
        vm.expectRevert(abi.encodeWithSelector(Error.FluidVaultError.selector, ErrorTypes.VaultT1__PositionAboveCF));
        vaultContract_.operate(1, -(100 * int(10 ** vaultData_.constantVariables.supplyDecimals)), 0, alice);

        vm.prank(alice);
        vm.expectRevert(abi.encodeWithSelector(Error.FluidVaultError.selector, ErrorTypes.VaultT1__PositionAboveCF));
        vaultContract_.operate(1, 0, 100 * int(10 ** vaultData_.constantVariables.borrowDecimals), alice);
    ...
    function _liquidateFromSinglePerfectTickTillLiquidationThreshold(bool positiveTick_) internal {
        ...
        uint liquidateAmt_ = 3000 * (10 ** vaultData_.constantVariables.borrowDecimals);
    ...
    function _liquidateSingleFromPerfectTickTillBetween(bool positiveTick_) public {
        ...
        uint liquidateAmt_ = 100 * (10 ** vaultData_.constantVariables.borrowDecimals);
    ...
    function _liquidateFromBranch(bool positiveTick_) public {
        ...
        liquidateAmt_ = 200 * (10 ** vaultData_.constantVariables.borrowDecimals);
    ...
    function _perfectTickAndBranchLiquidation(bool positiveTick_) public {
        ...
        uint liquidateAmt_ = 50 * (10 ** vaultData_.constantVariables.borrowDecimals);
        ...
        liquidateAmt_ = 49 * (10 ** vaultData_.constantVariables.borrowDecimals);
        ...
        liquidateAmt_ = 50 * (10 ** vaultData_.constantVariables.borrowDecimals);
    ...
    function _perfectTickAndMultipleBranchesLiquidation(bool positiveTick_) public {
        ...
        liquidateAmt_ = 500 * (10 ** vaultData_.constantVariables.borrowDecimals);
    ...
    function _tickBranchTickBranchLiquidation(bool positiveTick_) public {
        ...
        collaterals_[0] = 10000 * int(10 ** vaultData_.constantVariables.supplyDecimals);
        debts_[0] = 7990 * int(10 ** vaultData_.constantVariables.borrowDecimals);
        collaterals_[1] = 9_000 * int(10 ** vaultData_.constantVariables.supplyDecimals);
        debts_[1] = 6_800 * int(10 ** vaultData_.constantVariables.borrowDecimals);
        collaterals_[2] = 10000 * int(10 ** vaultData_.constantVariables.supplyDecimals);
        debts_[2] = 7990 * int(10 ** vaultData_.constantVariables.borrowDecimals);
        collaterals_[3] = 10000 * int(10 ** vaultData_.constantVariables.supplyDecimals);
        debts_[3] = 7990 * int(10 ** vaultData_.constantVariables.borrowDecimals);
        collaterals_[4] = 10000 * int(10 ** vaultData_.constantVariables.supplyDecimals);
        debts_[4] = 7_840 * int(10 ** vaultData_.constantVariables.borrowDecimals);
        ...
        liquidateAmt_ = 10000 * (10 ** vaultData_.constantVariables.borrowDecimals);
    ...
    function _unitializeFirstPosition(bool positiveTick_) public {
        ...
        uint liquidateAmt_ = 200 * 10 ** vaultData_.constantVariables.borrowDecimals;
    ...
    function _absorbMultiplePerfectTickOne(bool positiveTick_) public {
        ...
        int collateral_ = 10000 * int(10 ** vaultData_.constantVariables.supplyDecimals);
        int debt_ = 7990 * int(10 ** vaultData_.constantVariables.borrowDecimals);
        int debtTwo_ = 990 * int(10 ** vaultData_.constantVariables.borrowDecimals);
    ...
    function _absorbMultiplePerfectTickTwo(bool positiveTick_) public {
        ...
        uint liquidateAmt_ = 10000 * (10 ** vaultData_.constantVariables.borrowDecimals);
    ...
    function _absorbMultiplePerfectTickAndBranches(bool positiveTick_) public {
        ...
        int collateral_ = 10000 * int(10 ** vaultData_.constantVariables.supplyDecimals);
        int debt_ = 7990 * int(10 ** vaultData_.constantVariables.borrowDecimals);
        int debtTwo_ = 7800 * int(10 ** vaultData_.constantVariables.borrowDecimals);
        int debtThree_ = 900 * int(10 ** vaultData_.constantVariables.borrowDecimals);
    ...
    function _absorbBranch(bool positiveTick_) internal {
        ...
        int collateral_ = 10000 * int(10 ** vaultData_.constantVariables.supplyDecimals);
        int debt_ = 7990 * int(10 ** vaultData_.constantVariables.borrowDecimals);
        int debtTwo_ = 800 * int(10 ** vaultData_.constantVariables.borrowDecimals);
        ...
        liquidateAmt_ = 5000 * (10 ** vaultData_.constantVariables.borrowDecimals);
    ...
    function _absorbMultipleBranches(bool positiveTick_) internal {
        ...
        uint liquidateAmt_ = 500 * (10 ** vaultData_.constantVariables.borrowDecimals);
    ...
    function _absorbTickWhileBranchAsNextTopTick(bool positiveTick_) internal {
        ...
        liquidateAmt_ = 1000 * (10 ** vaultData_.constantVariables.borrowDecimals);
    ...
    function _absorbBranchWhileBranchAsNextTopTick(bool positiveTick_) internal {
        ...
        liquidateAmt_ = 100 * (10 ** vaultData_.constantVariables.borrowDecimals);
    ...
    function testInitializeBigAndDustUserAndChangeBigUser() public {
        ...
        vm.prank(alice);
        vm.expectRevert(abi.encodeWithSelector(Error.FluidVaultError.selector, ErrorTypes.VaultT1__TickIsEmpty));
    ...
    function _absorbAndUseAbsorbDustDebt(bool positiveTick_) public {
        ...
        int collateral_ = 10000 * int(10 ** vaultData_.constantVariables.supplyDecimals);
        int debtOne_ = 7990 * int(10 ** vaultData_.constantVariables.borrowDecimals);
        int debtTwo_ = 7900 * int(10 ** vaultData_.constantVariables.borrowDecimals);
        int debtThree_ = 7800 * int(10 ** vaultData_.constantVariables.borrowDecimals);
