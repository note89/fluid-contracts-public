...
contract VaultTicksBranchesResolverTest is Test {
    ...
    function setUp() public virtual {
        ...
        vaultResolver = new FluidVaultResolver(VAULT_FACTORY, LIQUIDITY, address(liquidityResolver));
...
contract VaultTicksBranchesResolverRobustnessTest is Test {
    ...
    function setUp() public virtual {
        ...
        vaultResolver = new FluidVaultResolver(address(VAULT_FACTORY), address(LIQUIDITY), address(liquidityResolver));
